...
def test_current_release_documents_follow_canonical_version():
    ...
    current_docs = [
        ROOT / "README-NL.md", ROOT / "docs/CHANGELOG.md", ROOT / "docs/AUDIT-REPORT.md",
        ROOT / "docs/CURSEFORGE-UPLOAD.md", ROOT / "docs/CURSEFORGE-BESCHRIJVING.md",
        ROOT / "docs/DEPENDENCIES.md", ROOT / "docs/LIVE-WOW-ACCEPTATIE.md", ROOT / "docs/SNELSTART.md",
        ROOT / "docs/TESTSCENARIOS.md", ROOT / "docs/UITGAVE-CHECKLIST.md", ROOT / "docs/TECHNIEK-EN-SCORE.md",
        ROOT / "docs/PROBLEMEN-OPLOSSEN.md",
    ]
    for path in current_docs:
        assert version in path.read_text(encoding="utf-8"), f"{path} does not describe canonical release {version}"
