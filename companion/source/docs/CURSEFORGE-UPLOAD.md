# CurseForge upload — KeystoneLens Bridge 0.12.7

Upload this file only:

`KeystoneLensBridge-0.12.7-CurseForge.zip`

Do **not** upload the master `KeystoneLens-Release-0.12.7.zip` as the WoW addon file. The master release also contains a Windows executable and documentation, while the nested CurseForge archive is intentionally limited to the WoW addon tree.
...
- use the 0.12.7 Season 2 compatibility changelog entry;
